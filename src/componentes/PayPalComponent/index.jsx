...
function PayPalComponent(cart) {

    let idOrderData
    let pagoOrderData
    let reservaOrderData


    const initialOptions = {
        "client-id": 'AVso9cIrSjAv0sXa9qjac2-4BJlKEgfz_ZUXnp85QodfQYYnTKOezODz5IAxfOcFv-H13-98xVTvOmag',
        currency: "USD",
                ...
                <PayPalButtons
                    ...
                    createOrder={async () => {
                        try {
                            ...
                            idOrderData = orderData.id
                            pagoOrderData = orderData.pago
                            reservaOrderData = orderData.reserva_id
                    ...
                    onApprove={async (data, actions) => {
                        const dataToSendConfirm = {
                            orderId: idOrderData,
                            total: pagoOrderData,
                            reservaId: reservaOrderData
                        }
                        try {

                            const response = await fetch('http://192.168.1.26/api/paypal-capture', {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                    'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..VPsULN8PnrW5EzFxiYlyn5R8ML4w0le-FvZFf1IxMOj2o2NVMUg-EERqJdKV3YWn2NquVgW8-SOPkmCtWJ4kfA_UZdaJ2JUkm0qo39cSNLt2AylXP8s4_pBK6cVBI8xo98fTkcoXgj-hDk6B04t4S2wIu7ddxSfgVdcWbVorN4Woac4i40d3xf6Iu-DnOfs6m5RKGDpOrzExQDrIn6A5_efpcNf1-I3rGgf00aAar2vKtdtZjFAzcVpDKMLm36Q-A0Yl54uEuC_e2RI2nsRhjtK7P0CwSPXzYyz29lU_k47WWJp4nVb0prt_-D5OHHk81LkFZqTiuiw5AB88_l3q65PG20oo8HSTW2c3hV1XPFHwhdVsjLncFX3TWhHUyHAIN48qBOiXl9JVmfeUj6t6uTurjRnaH-kykSke2dUPE77gCiMsLDUYA1dMD8EU42Y3F1tLWs4_CoXiwpjR2TGdjACY4FBHPwOAyrBpLIUKypeBcx3xrWcU2uZS7iTtQS_C2uhGyeMy0xSeBr0S0GICoJmiHmRUMc9gEHzlv40ObZpncXmw7VX1Txc5-DS6Y-GgjKjIPmmVQOWSJbjU7OqMtSaGyjmOTtECwgtlmFpfwEi0_g8L8T2OzgZVYOOROkzxOYnuCB1NLfj2N-NFcZ1cXUvB915l8C-v5ZD9Uulmxmsi'
                                ...
                                // use the "body" param to optionally pass additional order information
                                // like product ids and quantities
                                body: JSON.stringify(dataToSendConfirm),

                            });
                            console.log("🚀 ~ onApprove={ ~ dataToSendConfirm:", dataToSendConfirm)
